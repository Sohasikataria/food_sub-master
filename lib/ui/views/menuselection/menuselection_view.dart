...
class MenuselectionView extends StackedView<MenuselectionViewModel> {
                ...
                return Column(
                  children: [
                    ...
                    InkWell(
                      onTap: () => addreview(
                          context,
                          snapshot.data['rest'][0]['_id'],
                          int.parse(snapshot.data['rest'][0]['rating'])),
                      child: Container(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: snapshot.data['rest'][0]['review'].length,
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10)),
                            child: text_helper(
                              data: snapshot.data['rest'][0]['review'][index],
                              font: nunito,
                              color: kcDarkGreyColor,
                              bold: true,
                              size: fontSize12,
  ...
  void addreview(BuildContext context, String id, int rating) {
                  ...
                  button_helper(
                      onpress: () async {
                        if (message.text.toString().isEmpty || a == 0) {
                          ...
                          ApiHelper.addreview(
                              id, rating + a, message.text, context);
